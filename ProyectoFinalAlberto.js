...
const setCarrito = objecto => { //objecto
  //console.log(objecto)
  const producto = {
    id: document.querySelector('.btn-dark').dataset.id, //objeto.querySelector()
    titulo: document.querySelector("h5").textContent,
    precio: document.querySelector("p").textContent,
    cantidad: 1
  };
